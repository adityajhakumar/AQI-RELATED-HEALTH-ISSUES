...
st.markdown("<style>body {background-color: #e0f2f1; color: #004d40;}</style>", unsafe_allow_html=True)  # Green-white minimalist background
...
ax.set_title(f"Predicted Percentages for AQI = {avg_aqi}")
